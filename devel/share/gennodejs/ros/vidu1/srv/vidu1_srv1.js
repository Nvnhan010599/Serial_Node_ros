...
class vidu1_srv1Request {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type vidu1_srv1Request
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type vidu1_srv1Request
    let len;
    let data = new vidu1_srv1Request(null);
  ...
  static datatype() {
    ...
    return 'vidu1/vidu1_srv1Request';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new vidu1_srv1Request(null);
    if (msg.A !== undefined) {
      resolved.A = msg.A;
    }
    else {
...
class vidu1_srv1Response {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type vidu1_srv1Response
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type vidu1_srv1Response
    let len;
    let data = new vidu1_srv1Response(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new vidu1_srv1Response(null);
...
module.exports = {
  Request: vidu1_srv1Request,
  Response: vidu1_srv1Response,
  md5sum() { return '2a5c7a37218262bae4fcfaa1007692aa'; },
  datatype() { return 'vidu1/vidu1_srv1'; }
};
